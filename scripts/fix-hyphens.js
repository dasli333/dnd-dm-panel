...
const LEGITIMATE_HYPHENS = new Set([
  // Creatures
  'saber-toothed', 'cave-bear', 'dire-wolf', 'owlbear-cub',

  // Numbers
  'twenty-five', 'thirty-six', 'forty-five', 'fifty-five', 'sixty-six',
  'seventy-seven', 'eighty-eight', 'ninety-nine',

  // Measurements (will be handled by pattern matching)
  'one-foot', 'two-foot', 'three-foot', 'four-foot', 'five-foot',
  'six-foot', 'seven-foot', 'eight-foot', 'nine-foot', 'ten-foot',
  'eleven-foot', 'twelve-foot', 'fifteen-foot', 'twenty-foot',
  'twenty-five-foot', 'thirty-foot', 'forty-foot', 'fifty-foot',
  'sixty-foot', 'seventy-foot', 'eighty-foot', 'ninety-foot',

  // Weapons and items
  'war-hammer', 'battle-axe', 'hand-axe', 'cross-bow', 'long-bow',
  'short-bow', 'long-sword', 'short-sword',

  // Character types
  'half-elf', 'half-orc', 'half-dragon', 'were-wolf', 'were-bear',

  // Common compounds
  'well-known', 'long-term', 'short-term', 'high-level', 'low-level',
  'first-level', 'second-level', 'third-level', 'multi-attack',
  'self-destruct', 'non-magical', 'anti-magic', 'counter-attack',

  // Conditions and effects
  'spell-like', 'damage-dealing', 'mind-affecting'
]);

// Pattern for measurements (number + hyphen + foot/feet/inch/etc)
const MEASUREMENT_PATTERN = /\b(?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|fifteen|twenty|twenty-five|thirty|forty|fifty|sixty|seventy|eighty|ninety|\d+)-(?:foot|feet|inch|inches|mile|miles)\b/gi;

// Pattern for number-based measurements
const NUMERIC_MEASUREMENT_PATTERN = /\b\d+-(?:foot|feet|inch|inches|mile|miles|pound|pounds|level|day|days|hour|hours)\b/gi;
